// ListPage.jsx
import { useState, ChangeEvent, FormEventHandler, Dispatch, SetStateAction } from 'react';
...
interface ListPageProps {
  lions: Lion[];
  setLions: Dispatch<SetStateAction<Lion[]>>;
}
...
// 2. 메인 App 컴포넌트
function ListPage({lions, setLions}: ListPageProps) {
  ...
  // API 데이터를 형식에 맞게 변환
  const mapApiToLion = (user: any): Lion => {
